...
public enum SplittyPayErrorType {
    ...
    SplittyPayErrorType(final List<Integer> httpCodes,
                  final String reason) {
        this.httpCodes = unmodifiableList(httpCodes);
        this.reason = reason;
    }

    SplittyPayErrorType(final Integer httpCode,
                  final String reason) {
        this.httpCodes = unmodifiableList(singletonList(httpCode));
        this.reason = reason;
    }

    public static Optional<SplittyPayErrorType> byHttpCode(final int httpCode) {
